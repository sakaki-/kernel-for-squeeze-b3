...
* If you want all your existing Excito software to work fully, without any modifications, (or possibly if you are looking to upgrade to Debian Wheezy) you should consider using the 3.2.62 version in the [community-b3-kernel](https://github.com/Excito/community-b3-kernel) GitHub project, and maintained by MouettE (see also [this thread](http://http://forum.mybubba.org/viewtopic.php?f=7&t=5364) on the Excito forum). It contains all the relevant Excito and Debian patches.
